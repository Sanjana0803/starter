  ...
  return (
    ...
    <div className="flex items -start justify-center max-w-6xl mx-auto p-8 mt-24" >
        ...
        (<div className="flex flex-col lg:flex-row w-full">
          {/* cart ko dekhne ke liye if cart has item and no item  */}
          <div className="flex-1 lg:max-h-screen overflow-y-auto no-scrollbar pr-4">
            ...
            <div className="lg:ml-8 mt-8 lg:mt-0 p-6 flex flex-col justify-between h-[80vh]
            w-full lg:w-1/3 lg:sticky lg:top-20" >
               ...
               <div>
                  ...
                  <div className="text-lg text-gray-700 font-semibold">
                    <p className="mb-1 text-black">Total Amount:${totalAmount.toFixed(2)}</p>
      ...
      <div className="flex flex-col items-center">
          ...
          <Link to ={"/"}>
          <button className="border border-gray-300 py-2 px-6 text-[14px] rounded-md
          text-white font-semibold mt-4 bg-green-600">
          Shop Now
          </button>
          </Link>
          </div>
